...
function change_time() {
    ...
    var d14 = new Date().toLocaleString("en-US", {timeZone: "Asia/Shanghai"})
    var d15 = new Date().toLocaleString("en-US", {timeZone: "Asia/Hong_Kong"})
    var d16 = new Date().toLocaleString("en-US", {timeZone: "Asia/Tehran"})
    ...
    document.getElementById("phx_time").innerHTML = "Phoenix: " + d1 ;
    document.getElementById("jfk_time").innerHTML = "New York: " + d2;
    document.getElementById("kti_time").innerHTML = "Phnom Penh: " + d3;
    document.getElementById("lax_time").innerHTML = "San Francisco: " + d4;

    document.getElementById("den_time").innerHTML = "Denver: " + d5;
    ...
    document.getElementById("tlv_time").innerHTML = "Tehran: "+ d16;
