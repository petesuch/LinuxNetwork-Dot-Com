...
// Human-readable city name for each airport code, shown alongside the code
let cityMap = {
  "JFK": "New York",
  "PHX": "Phoenix",
  "KTI": "Phnom Penh",
...
function getFullDateAndTime() {
  ...
  for (airportCode in tzMap) {
    ...
    let cityName = cityMap[airportCode] || "";
    document.getElementById(airportCode).innerHTML = airportCode + " (" + cityName + "):  " + idtf_str;
  }
};
